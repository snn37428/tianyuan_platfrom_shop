...
//import com.platform.util.wechat.Signature;
...
//public class ApiPayController2 extends ApiBaseAction {
...
//
//        try {
//            Map<Object, Object> parame = new HashMap<Object, Object>();
...
//            parame.put("device_info", "");
//            parame.put("fee_type", "CNY");
//            //支付金额
//            parame.put("total_fee", String.valueOf(orderInfo.getActual_price().multiply(new BigDecimal(100)).intValue()));
//            // IP ID
...
//
//            // 甜圆新签证
//            String reslut = Signature.signMapBuildObject(parame);
//            logger.info("---------下单返回:" + reslut);
//            Map<String, Object> resultUn = XmlUtil.xmlStrToMap(reslut);
//            // 响应报文
